...
namespace WeCantSpell.Roslyn.Tests.Integration.CSharp.Parsing
{
    ...
    {
        public static object[][] CanFindSpellingMistakesInLocalsData => new[]
        {
        ...
        public async Task can_find_spelling_mistakes_in_locals(string expectedWord, int expectedLine,
        ...
        )
        {
            ...
            diagnostics.Should().ContainSingle()
                .Subject.Should()
                .HaveId("SP3110")
                .And.HaveLineLocation(expectedLine, expectedCharacter, expectedWord.Length, "LocalVariables.SimpleExamples.csx")
