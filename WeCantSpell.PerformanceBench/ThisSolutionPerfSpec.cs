...
namespace WeCantSpell.PerformanceBench
{
    public class ThisSolutionPerfSpec
    {
        ...
        private async Task<ImmutableArray<Diagnostic>> FindSpellingMistakesForProject(Project project, SpellingAnalyzerCSharp analyzer)
        {
